...
TOKEN = '7233401634:AAH-9VRpKqdC5GTqHh8Jds4mnvb3LSwNgQM'
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "Привет! Я бот для управления компьютером. Выберите категорию:", reply_markup=markup)
...
def handle_message(message):
    if message.text == 'Управление ПК':
        ...
        tg_path = r'C:\Users\vipma\AppData\Roaming\Telegram Desktop\Telegram.exe'
        ...
        bot.send_message(message.chat.id, response)
# Функция для отложенного выключения
